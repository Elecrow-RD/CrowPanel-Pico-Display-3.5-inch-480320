...
//3.5
LV_IMG_DECLARE(ui_img_812486673);    // assets\wizee_logo_02_120x30.png
LV_IMG_DECLARE(ui_img_1434761727);    // assets\Wizee-ESP32-02-01.png
LV_IMG_DECLARE(ui_img_301750498);    // assets\480x320_R035.png
